...
## [2026-03-18 17:30] — Hero description max-width standardization

- **What:** Standardized hero description max-widths to `max-w-xl` (36rem) across 16 pages
- **Why:** Hero descriptions used 3 different widths (`max-w-lg`, `max-w-xl`, `max-w-2xl`), creating inconsistent line lengths and breaking editorial rhythm. The spec mandates `max-w-xl`.
- **Risk:** LOW
- **Files changed:** index.html, about.html, case-study.html, casehub.html, contact.html, insights.html, industries/courts.html, industries/manufacturing.html, industries/growth-stage.html, insights/build-vs-buy.html, insights/case-management-2026.html, insights/legacy-cost.html, insights/mid-market-software-gap.html, insights/12-county-migration.html, insights/200-projects-scope.html, insights/3d-product-visualization.html
- **Not changed:** work.html (flex layout, no hero description wrapper), services/* and how-we-work.html (already `max-w-xl`)
- **Edge cases handled:** Non-hero `max-w-2xl` instances (featured article cards, FAQ answers, CTA sections) intentionally preserved
